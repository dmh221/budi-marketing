      ...
      <div className="h-full overflow-y-auto hide-scrollbar">
        ...
        <div className="px-4 pt-4 pb-6 space-y-4">
          <div className="flex flex-col items-center text-center space-y-3">
            <div className="w-20 h-20 rounded-full bg-budi-lime/10 flex items-center justify-center flex-shrink-0">
              <UserCircleIcon className="w-12 h-12 text-budi-lime" aria-hidden="true" />
            </div>
            <div>
        ...
        <div className="px-4 pb-4">
          <div className="grid grid-cols-3 gap-2">
            ...
            <button className="bg-card relative rounded-md overflow-hidden w-full h-[84px] transition-transform hover:scale-[1.02] active:scale-[0.99] focus:outline-none group" aria-label="View recipe">
