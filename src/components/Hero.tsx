...
export default function Hero() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative pt-40 md:pt-44 lg:pt-48 pb-28 md:pb-32 lg:pb-36 px-6 overflow-hidden"
      style={{
    ...
    >
      ...
      >
        ...
        <motion.h1
          className="text-4xl md:text-5xl lg:text-6xl font-semibold text-black mb-5 mx-auto cursor-pointer"
          style={{
            maxWidth: '820px',
