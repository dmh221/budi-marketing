  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-16">
      ...
      <div className="space-y-12">
        <section>
          <h2 className="text-base font-semibold text-black mb-4 uppercase">Introduction</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-black mb-4 uppercase">Information We Collect</h2>
          <div className="space-y-4 text-secondary leading-relaxed text-justify text-sm">
            <div>
        ...
        <section>
          <h2 className="text-base font-semibold text-black mb-4 uppercase">How We Use Your Information</h2>
          <div className="space-y-4 text-secondary leading-relaxed text-justify text-sm">
        ...
        <section>
          <h2 className="text-base font-semibold text-black mb-4 uppercase">Information Sharing</h2>
          <div className="space-y-4 text-secondary leading-relaxed text-justify text-sm">
            <div>
        ...
        <section>
          <h2 className="text-base font-semibold text-black mb-4 uppercase">Your Privacy Controls</h2>
          <div className="space-y-4 text-secondary leading-relaxed text-justify text-sm">
            <div>
        ...
        <section>
          <h2 className="text-base font-semibold text-black mb-4 uppercase">Data Security and Retention</h2>
          <div className="space-y-4 text-secondary leading-relaxed text-justify text-sm">
        ...
        <section>
          <h2 className="text-base font-semibold text-black mb-4 uppercase">Children's Privacy</h2>
          <div className="text-secondary leading-relaxed text-justify text-sm">
            <p>Budi is not intended for children under 18. We do not knowingly collect personal information from children under 18. If we become aware that a child under 18 has provided us with personal information, we will delete such information immediately.</p>
          </div>
        </section>

        <section>
          <h2 className="text-base font-semibold text-black mb-4 uppercase">Third-Party Services</h2>
          <div className="text-secondary leading-relaxed text-justify text-sm">
        ...
        <section>
          <h2 className="text-base font-semibold text-black mb-4 uppercase">External Links</h2>
          <div className="text-secondary leading-relaxed text-justify text-sm">
        ...
        <section>
          <h2 className="text-base font-semibold text-black mb-4 uppercase">Changes to This Policy</h2>
          <div className="space-y-4 text-secondary leading-relaxed text-justify text-sm">
        ...
        <section>
          <h2 className="text-base font-semibold text-black mb-4 uppercase">Contact Us</h2>
          <div className="text-secondary leading-relaxed text-justify text-sm">
            <p>
        ...
        <section>
          <h2 className="text-base font-semibold text-black mb-4 uppercase">Your California Privacy Rights (CCPA)</h2>
          <div className="space-y-4 text-secondary leading-relaxed text-justify text-sm">
        ...
        <section>
          <h2 className="text-base font-semibold text-black mb-4 uppercase">European Users (GDPR)</h2>
          <div className="space-y-4 text-secondary leading-relaxed text-justify text-sm">
